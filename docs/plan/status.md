...
| 6 | 6.7 Background services | QA approved | two jthread lanes; bounded queues; cancellation; 28 checks |
| 6 | 6.8 Fixed startup order | Not started | explicit startup and reverse shutdown remain |
